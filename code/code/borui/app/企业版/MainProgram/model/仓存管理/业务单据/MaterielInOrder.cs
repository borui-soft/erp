...
namespace MainProgram.model
{
    ...
    public class MaterielInOrder : ITableModel
    {
        private bool m_isRedBill = false;
        private SortedDictionary<int, MaterielInOrderTable> m_tableDataList = new SortedDictionary<int, MaterielInOrderTable>();

        static private MaterielInOrder m_instance = null;

        private MaterielInOrder()
        {
            load();
        }
        ...
        static public MaterielInOrder getInctance()
        {
            if (m_instance == null)
            {
                m_instance = new MaterielInOrder();
            }

            return m_instance;
        }

        public void insert(MaterielInOrderTable record, bool isDisplayMessageBox = true)
        {
            bool isExistReview = false;
            MaterielInOrderTable oldRecord = new MaterielInOrderTable();

            string insert = "INSERT INTO [dbo].[WAREHOUSE_MANAGEMENT_IN]([DEPARTMENT_ID],[TRADING_DATE],[BILL_NUMBER],";
            ...
            if (checkBillIsExist(record.billNumber))
            {
                if (checkBillIsReview(record.billNumber))
                {
                    ...
                    oldRecord = getMaterielInOrderInfoFromBillNumber(record.billNumber);
                }
            ...
            writeOperatorLog(301, OperatorLogType.Add, record.billNumber);
        }

        public void delete(string billNumber)
        {
            string delete = "DELETE FROM WAREHOUSE_MANAGEMENT_IN WHERE BILL_NUMBER = '" + billNumber + "'"; 
        ...
        {
            // 更新单据审核标志，把审核标志置为1
            string update = "UPDATE [dbo].[WAREHOUSE_MANAGEMENT_IN] SET ";
            ...
            writeOperatorLog(301, OperatorLogType.Review, billNumber);
        }
        ...
        private void load()
        {
            ...
            sql += "FROM [dbo].[WAREHOUSE_MANAGEMENT_IN] ORDER BY PKEY";
        ...
        public SortedDictionary<int, MaterielInOrderTable> getAllMaterielInOrderInfo()
        {
        ...
        public SortedDictionary<int, MaterielInOrderTable> getAllReviewMaterielInOrderInfo()
        {
            SortedDictionary<int, MaterielInOrderTable> list = new SortedDictionary<int, MaterielInOrderTable>();

            foreach (KeyValuePair<int, MaterielInOrderTable> index in m_tableDataList)
            {
                MaterielInOrderTable record = new MaterielInOrderTable();
                record = index.Value;
        ...
        public SortedDictionary<int, MaterielInOrderTable> getAllNotReviewMaterielInOrderInfo()
        {
            SortedDictionary<int, MaterielInOrderTable> list = new SortedDictionary<int, MaterielInOrderTable>();
        ...
        public MaterielInOrderTable getMaterielInOrderInfoFromBillNumber(string billNumber)
        {
            MaterielInOrderTable record = new MaterielInOrderTable();
        ...
        public bool checkBillIsReview(string billNumber)
        {
            ...
            string sql = "SELECT [IS_REVIEW] FROM WAREHOUSE_MANAGEMENT_IN WHERE BILL_NUMBER = '" + billNumber + "'";
    ...
    public class MaterielInOrderTable
    {
