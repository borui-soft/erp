...
namespace MainProgram.model
{
    ...
    public class MaterielInOtherOrder : ITableModel
    {
        ...
        {
            writeOperatorLog(303, OperatorLogType.Register, billNumber, "开始");
            /*函数处理逻辑如下：
            ...
            writeOperatorLog(303, OperatorLogType.Register, billNumber, "结束");
        }
        ...
        public bool checkBillIsReview(string billNumber)
        {
            ...
            string sql = "SELECT [IS_REVIEW] FROM WAREHOUSE_MANAGEMENT_IN_OTHER WHERE BILL_NUMBER = '" + billNumber + "'";
