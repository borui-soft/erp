...
namespace MainProgram.model
{
    ...
    public class MaterielInOtherOrderDetails : ITableModel
    {
        private SortedDictionary<int, MaterielInOtherOrderDetailsTable> m_tableDataList = new SortedDictionary<int, MaterielInOtherOrderDetailsTable>();

        static private MaterielInOtherOrderDetails m_instance = null;

        private MaterielInOtherOrderDetails()
        {
            load();
        }
        ...
        static public MaterielInOtherOrderDetails getInctance()
        {
            if (m_instance == null)
            {
                m_instance = new MaterielInOtherOrderDetails();
            }
        ...
        public void insert(ArrayList orderDetailsRecords)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        MaterielInOtherOrderDetailsTable record = (MaterielInOtherOrderDetailsTable)orderDetailsRecords[i];
                        ...
                        string insert = "INSERT INTO [dbo].[WAREHOUSE_MANAGEMENT_IN_OTHER_DETAILS]([ROW_NUMBER],[MATERIEL_ID],[BILL_NUMBER]";
        ...
        {
            string delete = "DELETE FROM WAREHOUSE_MANAGEMENT_IN_OTHER_DETAILS WHERE BILL_NUMBER = '" + billNumber + "'";
        ...
        private void load()
        {
            ...
            querySQL += " FROM [WAREHOUSE_MANAGEMENT_IN_OTHER_DETAILS] A1, WAREHOUSE_MANAGEMENT_IN_OTHER A2";
        ...
        public SortedDictionary<int, MaterielInOtherOrderDetailsTable> getAllMaterielInOtherOrderInfo()
        {
        ...
        public SortedDictionary<int, MaterielInOtherOrderDetailsTable> getMaterielInOtherInfoFromBillNumber(string billNumber)
        {
            SortedDictionary<int, MaterielInOtherOrderDetailsTable> list = new SortedDictionary<int, MaterielInOtherOrderDetailsTable>();

            foreach (KeyValuePair<int, MaterielInOtherOrderDetailsTable> index in m_tableDataList)
            {
        ...
        public SortedDictionary<int, MaterielInOtherOrderDetailsTable> getMaterielInOtherOrderCountInfo(string startDate, string endDate, bool isAllBill = false)
        {
            SortedDictionary<int, MaterielInOtherOrderDetailsTable> dataList = new SortedDictionary<int, MaterielInOtherOrderDetailsTable>();
            string querySQL = "SELECT A1.[PKEY],A1.[ROW_NUMBER],A1.[MATERIEL_ID], A1.[BILL_NUMBER],A1.[PRICE],A1.[VALUE],A1.[NOTE] ";
            querySQL += "FROM [WAREHOUSE_MANAGEMENT_IN_OTHER_DETAILS] A1, WAREHOUSE_MANAGEMENT_IN_OTHER A2";
            querySQL += " WHERE A1.BILL_NUMBER = A2.BILL_NUMBER";
    ...
    public class MaterielInOtherOrderDetailsTable
    {
