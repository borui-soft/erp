...
namespace MainProgram.model
{
    ...
    public class MaterielOutEarningsOrder : ITableModel
    {
        ...
        private double getMaterielCountFromID(int materielID, SortedDictionary<int, MaterielOutEarningsOrderDetailsTable> dataList)
        {
            double value = 0.0;
        ...
        public bool checkBillIsReview(string billNumber)
        {
            ...
            string sql = "SELECT [IS_REVIEW] FROM WAREHOUSE_MANAGEMENT_OUT_EARNINGS WHERE BILL_NUMBER = '" + billNumber + "'";
