...
namespace MainProgram.model
{
    ...
    public class MaterielOutOrder : ITableModel
    {
        ...
        private double getMaterielCountFromID(int materielID, SortedDictionary<int, MaterielOutOrderDetailsTable> dataList)
        {
            double value = 0.0;
        ...
        public bool checkBillIsReview(string billNumber)
        {
            ...
            string sql = "SELECT [IS_REVIEW] FROM WAREHOUSE_MANAGEMENT_OUT WHERE BILL_NUMBER = '" + billNumber + "'";
