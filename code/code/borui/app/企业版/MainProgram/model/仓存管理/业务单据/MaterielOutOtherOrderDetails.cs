...
namespace MainProgram.model
{
    ...
    public class MaterielOutOtherOrderDetails : ITableModel
    {
        private SortedDictionary<int, MaterielOutOtherOrderDetailsTable> m_tableDataList = new SortedDictionary<int, MaterielOutOtherOrderDetailsTable>();

        static private MaterielOutOtherOrderDetails m_instance = null;

        private MaterielOutOtherOrderDetails()
        {
            load();
        }

        static public MaterielOutOtherOrderDetails getInctance()
        {
            if (m_instance == null)
            {
                m_instance = new MaterielOutOtherOrderDetails();
            }
        ...
        {
            string delete = "DELETE FROM WAREHOUSE_MANAGEMENT_OUT_OTHER_DETAILS WHERE BILL_NUMBER = '" + billNumber + "'";
        ...
        public SortedDictionary<int, MaterielOutOtherOrderDetailsTable> getAllMaterielOutOtherOrderInfo()
        {
        ...
        public SortedDictionary<int, MaterielOutOtherOrderDetailsTable> getMaterielOutOtherInfoFromBillNumber(string billNumber)
        {
            SortedDictionary<int, MaterielOutOtherOrderDetailsTable> list = new SortedDictionary<int, MaterielOutOtherOrderDetailsTable>();
    ...
    public class MaterielOutOtherOrderDetailsTable
    {
