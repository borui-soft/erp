...
namespace MainProgram.model
{
    ...
    public class PurchaseInOrder : ITableModel
    {
        ...
        public SortedDictionary<int, PurchaseInOrderTable> getAllPurchaseOrderInfoFromProjectNum(string projectNum)
        {
        ...
        public bool checkBillIsReview(string billNumber)
        {
            ...
            string sql = "SELECT [IS_REVIEW] FROM PURCHASE_IN_ORDER WHERE BILL_NUMBER = '" + billNumber + "'";
