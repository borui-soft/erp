...
namespace MainProgram
{
    public partial class FormMaterielOutOtherOrder : Form
    {
        ...
        public FormMaterielOutOtherOrder(string billNumber = "")
        {
            InitializeComponent();
            m_billNumber = billNumber;
        }

        private void FormMaterielOutOtherOrder_Load(object sender, EventArgs e)
        {
            // DataGridView初始化
            dataGridViewInit();
        ...
        private ArrayList getMaterielOutOtherOrderDetailsValue()
        {
        ...
        {
            SortedDictionary<int, ActionTable> list = MainProgram.model.Action.getInctance().getActionInfoFromModuleID(306);
